...
import TabOneOpportunite from '@/app/ui/commercial/opportunite/tab1'
import TabOTwoOpportunite from '@/app/ui/commercial/opportunite/tab2'

const tabs = [
  { id: 'dashboard', label: "Opportunité" },
  { id: 'invoices', label: "Devis" },
]
...
export default function InvoiceDashboard() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mt-4">
        {activeTab === 'dashboard' && <TabOneOpportunite />}
        {activeTab === 'invoices' && (
           <TabOTwoOpportunite />
        )}
      </div>
