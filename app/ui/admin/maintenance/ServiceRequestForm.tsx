      ...
      <DialogContent className="sm:max-w-[700px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div>
                <RequiredLabel>Techniciens</RequiredLabel>
                <div className="relative mt-2">
                  <Input
                    type="text"
                    placeholder="Recherche..."
                    ...
                    className={cn("pl-8", formErrors.technicians && "border-red-500 focus-visible:ring-red-500")}
                  />
                  <MagnifyingGlassIcon className="absolute left-2 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" />
                </div>
                <div className="mt-2 space-y-2 max-h-40 overflow-y-auto">
                  {filteredTechnicians.map((tech) => (
                    <div key={tech.id} className="flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg">
                      ...
                      <input
                        ...
                        className={cn("rounded border-gray-300", formErrors.technicians && "border-red-500")}
                      />
                    </div>
                  ))}
                </div>
